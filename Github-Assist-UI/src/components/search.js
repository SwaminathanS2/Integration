...
/**
 * Centralized search UI + API utilities for Feature Switch usage lookup.
 * - Exports <FeatureFilesCard /> UI component
...
// Resolve API base and search endpoint once, using the same logic you had in Home.js
...
// Optional re-exports in case you need them elsewhere later
